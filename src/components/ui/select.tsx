...
function SelectTrigger({
  ...
  children,
  ...props
}: ComponentProps<typeof SelectPrimitive.Trigger> & { size?: 'sm' | 'default' }): React.JSX.Element {
  return (
...
/** Popover surface that lists the selectable options. */
...
/** Non-selectable heading for a {@link SelectGroup}. */
...
/** Visual divider between groups of options. */
